...
const Skills = () => {
  return (
    <>
      <h2 className='font-bold text-8xl mt-64 w-full text-center pb-16 md:text-6xl md:mt-32'>Skills</h2>
      <div className='w-full h-screen relative flex items-center justify-center bg-circularLight dark:bg-circularDark lg:h-[80vh] sm:h-[60vh] xs:h-[50vh]
      ...
      lg:bg-circularLightLg lg:dark:bg-circularDarkLg
       md:bg-circularLightLg md:dark:bg-circularDarkLg
        ...
        <Skill name="NextJS" x="-32vw" y="-9vw"/>
        <Skill name="NodeJS" x="15vw" y="-12vw"/>
        <Skill name="ExpressJS" x="32vw" y="-5vw"/>
        <Skill name="MonogDB" x="0vw" y="-20vw"/>
