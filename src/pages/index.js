  ...
  return (
    <>
      ...
      <main className='flex items-center text-dark w-full min-h-screen dark:text-light '>
        <Layouts className='pt-0 md:pt-16 sm:pt-8'>
          <div className='flex items-center justify-between w-full lg:flex-col '>
            ...
            <AnimatedText text="Turning Vision Into Reality With Code And Design."className='!text-5xl !text-left xl:!text-5xl lg:!text-center lg:!text-6xl md:!text-5xl sm:!text-3xl'/>
              <p className="my-5 text-base font-medium  md:text-sm sm:text-xs sm:text-center">
                As a skilled full-stack developer, I am dedicated to turning
                ideas into innovative web applications. Explore my latest projects
                and articles, showcasing my expertise in React.js and
                web development.
              </p>
              <div className="flex items-center self-start mt-2 lg:self-center">
                <Link href="/ayushnegi.pdf"target={"_blank"}
                ...
                <Link href="mailto:ayushnegi7428@gmail.com"target={"_blank"}
        ...
        {/* <div className="absolute right-6 bottom-8 inline-block w-20">
          <Image src={lightBulb} alt="Ayush Negi" className="w-full h-auto"/>
        </div> */}
